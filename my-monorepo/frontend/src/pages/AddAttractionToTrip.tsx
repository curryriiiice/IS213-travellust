  ...
  useEffect(() => {
    const loadTrips = async () => {
      ...
      try {
        ...
        setSelectedTripId('');
        setError(
          'Could not load your real trips. Please make sure the trips service is running.',
        );
      } finally {
    ...
    try {
      await saveCatalogAttraction(
        ...
        attraction,
        {
          ...
          visitTime,
          durationMinutes:
            Number(durationMinutes) || attraction.durationMinutes || 120,
        ...
        >
          ...
          <div className="p-6">
            ...
            <div className="flex items-center gap-2 mt-3 flex-wrap">
              <Badge
                variant="outline"
                className="text-[10px] border-node-attraction/30 text-node-attraction"
              >
                {attraction.category}
              </Badge>
        ...
        >
          <div>
            ...
            <p className="text-sm text-muted-foreground mt-1">
              Pick a trip and visit date to save this attraction into your
              itinerary.
            </p>
          </div>
            ...
            {isLoadingTrips ? (
              <div className="space-y-2">
                {[1, 2, 3].map((index) => (
                  <div
                    key={index}
                    className="h-16 rounded-sm border border-border bg-secondary/20 animate-pulse"
                  />
                ))}
              </div>
            ) : trips.length === 0 ? (
          ...
          <div className="pt-4 border-t border-border flex items-center justify-between gap-3">
            <div className="min-w-0">
              ...
              <p className="text-sm font-medium truncate">
                {selectedTrip?.name ?? 'None selected'}
              </p>
            </div>
            <Button
              variant="accent"
